...
CREATE TABLE employee (
  ...
  em_ssn varchar(6) NOT NULL UNIQUE,
  em_marriage varchar(20) NOT NULL,
  em_nationality varchar(50) NOT NULL,
  em_education varchar(20) NOT NULL,
  em_enrollment_date date NOT NULL,
...
INSERT INTO employee VALUES (null, 'Kaifu', 'Wang', 'male', '1991-10-08', '123456', 'married', 'China', 'education', 'master', '2016-03-03', 'kaifuww@gmail.com', 'Developer', '4129999999', 'pittsburgh', null, 03);